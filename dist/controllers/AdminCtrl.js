...
angular.module("coreApp").controller("AdminMenuCtrl", ['$scope' ,function ($scope) {
...
angular.module("coreApp").controller("ActivityTypesCtrl", [ '$scope','$location','GlobalSvc','Settings','$routeParams','$http','$alert', function ($scope,$location,GlobalSvc,Settings,$routeParams,$http,$alert) {
...
angular.module("coreApp").controller('TreeCtrl',['$scope','$location','GlobalSvc','Settings','$routeParams','$http', function($scope,$location,GlobalSvc,Settings,$routeParams,$http){
    $scope.trees = [];
    $scope.treeEdit = {};
    $scope.JSONField = undefined;
...
angular.module("coreApp").controller("UserCtrl",['$scope','$route','$routeParams','$http','GlobalSvc','Settings','JsonFormSvc','$window','$location','$modal', function($scope,$route,$routeParams,$http,GlobalSvc,Settings,JsonFormSvc,$window,$location,$modal){
    $scope.$emit('heading',{heading: 'Users' , icon : 'fa fa-user'});
    $scope.users = [];
    $scope.userEdit = {};
    $scope.userRoleModal = undefined;
...
angular.module("coreApp").controller("OptionsCtrl", ['$scope', 'GlobalSvc', 'DaoSvc', 'Settings', '$routeParams', '$http',function ($scope, GlobalSvc, DaoSvc, Settings, $routeParams, $http) {
    //$scope.mode = 'list';
    $scope.options = [];
    $scope.option = {};
...
angular.module("coreApp").controller("ProdEditCtrl",['$scope', 'GlobalSvc', 'DaoSvc', 'Settings', '$routeParams', '$http', '$alert', function ($scope, GlobalSvc, DaoSvc, Settings, $routeParams, $http, $alert) {
    $scope.mode = 'list';
...
angular.module("coreApp").controller("UserExitCtrl",['$scope','GlobalSvc','DaoSvc','Settings','$routeParams','$http', function ($scope, GlobalSvc, DaoSvc, Settings, $routeParams, $http) {
...
angular.module("coreApp").controller('ProdCatCtrl',['$scope','$http','GlobalSvc','Settings','$routeParams','$location','$modal','$route', '$alert' ,function($scope,$http,GlobalSvc,Settings,$routeParams,$location,$modal,$route, $alert){
    var user = GlobalSvc.getUser();
    $scope.categories = [];
    $scope.catEdit = {};
...
angular.module("coreApp").controller('DVCtrl',['$scope','$filter','GlobalSvc','Settings','$routeParams','$alert','$http', '$location','$window', function($scope, $filter, GlobalSvc, Settings, $routeParams, $alert,  $http, $location, $window){
    $scope.Discounts = [];
    var user = GlobalSvc.getUser();
    //$scope.searchText = '';

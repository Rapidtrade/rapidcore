coreApp.controller('PromoCtrl',function($scope,$routeParams,$http,$alert,GlobalSvc,Settings, $modal, $filter){
    ...
    function initPromotionSelectfield(){
        ...
        $scope.promoFields.ObjectPropertyAC = ['All','AccountID','AccountGroup','Userfield01']; //Object Property fields for the Account Condition
    ...
    $scope.fetchPossibleValues = function(searchStr, attribute) {
    	$scope.$emit('LOAD');
    	var table = attribute.indexOf('Acco') !== -1 ? 'account' : 'product';

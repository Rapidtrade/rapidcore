coreApp.directive("jsoncards", function(GlobalSvc, $http, $sce, DaoSvc, Settings, $location) {
    ...
    return { 
        ...
        template:
            ...
            '   <div class="panel panel-default group-panel"> <div class="panel-body cardBox">' + 
            ...
            '      </a></div> <div class="panel-footer text-center group-footer" style="color:#31373D;">{{json[$index][headingField]}}   </div></div></div>' +
            '</div>',        
        scope: {
            url: '@',
            onfetch: '&',
